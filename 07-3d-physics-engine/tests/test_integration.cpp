...
TEST_CASE("box stack stability test", "[integration]") {
    ...
    for (const auto& body : world.bodies()) {
        ...
        REQUIRE(body->position.y > -5.0f);
        REQUIRE(body->position.y < 15.0f);
    }
}
